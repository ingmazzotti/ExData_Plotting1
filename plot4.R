...
#2
with(f_data, plot(as.POSIXct(mydatetime), Voltage, type="l",xlab="datetime",ylab="Voltage"))

#3
with(f_data, plot(as.POSIXct(mydatetime), Sub_metering_1, type="l", xlab = "", ylab = "Energy sub metering"))
with(f_data, lines(as.POSIXct(mydatetime), Sub_metering_2 , type="l", col= "red", xlab = ""))
with(f_data, lines(as.POSIXct(mydatetime), Sub_metering_3, type="l", col= "blue", xlab = ""))
legend("topright", col=c("black","red","blue"), legend= c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=1)

#4
with(f_data, plot(as.POSIXct(mydatetime), Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power"))
